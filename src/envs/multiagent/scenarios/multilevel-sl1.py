...
class Scenario(BaseScenario):
    ...
    def reset_world(self, world):
        ...
        world.landmarks[1].state.p_pos = np.array([0.9, -0.85]) / self.scale_factor
        ...
        world.walls[7].state.end = np.array([0.5, 0.69]) / self.scale_factor

        world.walls[8].state.start = np.array([0.5, 0.81]) / self.scale_factor
